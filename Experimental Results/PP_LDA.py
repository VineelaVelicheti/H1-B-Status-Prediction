...
#Feauture Selection : Fisher's LDA

import time
from sklearn.discriminant_analysis import LinearDiscriminantAnalysis

start_time = time.clock()
lda = LinearDiscriminantAnalysis(solver='svd',n_components=15000)
lda = lda.fit(train_data,Y_train)

Train_PCA = lda.transform(train_data)
print(Train_PCA.shape)

Test_PCA = lda.transform(test_data)
